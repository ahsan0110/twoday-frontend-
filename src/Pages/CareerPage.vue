...
// Reactive refs for title and meta tags
const titleTag = ref("Career");
const metaTagsRaw = ref([]);

// Computed unwraps the array so useHead reacts properly
...
<template>
    ...
    <HeroSection 
        smallText="CAREERS" 
        largeText="Tomorrow is built by the<br>people who engineer it"
        ctaText="Talk to an expert" 
        ctaLink="#form-section-id" 
        videoSrc="Industries-Hero.mp4" 
        heroClass="career-hero" 
    />
    ...
    <FrankComponent 
        expertTag="Meet Our People" 
        expertNameRole="Meet Frank<br>AI & Engineering" 
        expertCTA="Read More"
